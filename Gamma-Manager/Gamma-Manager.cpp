...
// Gamma-Manager.cpp: определяет поведение классов для приложения.
//
...
// Единственный объект CGammaManagerApp

CGammaManagerApp theApp;


// Инициализация CGammaManagerApp
